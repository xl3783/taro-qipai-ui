      ...
      <View className='bg-white rounded-lg p-6 w-80'>
        <View className='flex flex-col items-center space-y-2'>
          <View className='w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center mb-2'>
            {player.avatar ? <Image src={player.avatar} className='w-full h-full rounded-full' mode='aspectFill' /> : <Text>👤</Text>}
          </View>
        ...
        <View className='grid grid-cols-2 gap-3'>
          ...
          <Button onClick={onExitRoom} className='bg-orange-500 hover:bg-orange-600'>退出房间</Button>
        </View>
